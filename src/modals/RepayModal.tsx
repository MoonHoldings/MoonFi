...
export const RepayModal = ({ visible, onClose }: { visible: boolean; onClose?: any }) => {
      ...
      <Screen style={tw`flex bg-black p-[16px]`}>
        <View style={tw`flex w-full bg-[#1F2126] rounded-md p-[16px]`}>
          ...
          <View style={tw`flex flex-row w-full mt-1 px-12`}>
            <View style={tw`flex flex-1 items-center`}>
              <Text style={{ ...tw`text-white text-[16px]`, fontFamily: Fonts.PoppinsRegular }}>7</Text>
            </View>
            <View style={tw`flex flex-1 items-center`}>
              <Text style={{ ...tw`text-white text-[16px]`, fontFamily: Fonts.PoppinsRegular }}>12</Text>
            </View>
            <View style={tw`flex flex-1 items-center`}>
              <Text style={{ ...tw`text-white text-[16px]`, fontFamily: Fonts.PoppinsRegular }}>5</Text>
            </View>
          </View>
          ...
          <TouchableOpacity style={tw`border border-2 border-[#63ECD2] rounded-md items-center py-3 px-8 bg-[#63ECD2] w-full mt-2`} onPress={() => console.log("yes")}>
            <Text
              style={{
