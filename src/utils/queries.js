...
export const LOAN_SUMMARY = gql`
  query GetLoanSummary($borrower: String, $lender: String, $paginationToken: String) {
    getLoanSummary(borrower: $borrower, lender: $lender, paginationToken: $paginationToken) {
      data {
        offerBlocktime
        cancelBlocktime
        takenBlocktime
...
export const GET_BEST_OFFER_FOR_EXTEND = gql`
  query GetBestOfferForExtend($args: GetLoansArgs) {
    getLoans(args: $args) {
      data {
        orderBook {
          apy
